...
const options = {
  definition: {
    ...
    tags: [
      ...
      { name: 'Admin Tour Content Items', description: 'Reusable individual highlights, requirements, inclusions, exclusions and policies' },
    ...
    components: {
      ...
      schemas: {
        TourDetail: {
          type: 'object',
          properties: {
            tour_id: { type: 'integer', example: 6 },
            slug: { type: 'string', example: 'suoi-tien-one-day-tour' },
            name: { type: 'string', example: 'Suoi Tien' },
            short_description: { type: 'string', nullable: true },
            description: { type: 'string', nullable: true },
            thumbnail_url: { type: 'string', nullable: true },
            video_url: { type: 'string', nullable: true },
            gallery: { type: 'array', items: { type: 'object' } },
            tour_category: { type: 'object', nullable: true },
            tour_type: { type: 'string', enum: ['group', 'private', 'self_guided'] },
            languages: { type: 'array', items: { type: 'string' }, example: ['vi', 'en'] },
            ...
            average_rating: { type: 'number', example: 4.8 },
            review_count: { type: 'integer', example: 125 },
