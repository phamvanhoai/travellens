...
async function run() {
  ...
  try {
    ...
    const contentSpecs = [
      ...
      ['cancellation_policy', 'Hoàn 100% khi hủy trước ngày khởi hành 7 ngày'],
    ];
    const contentItems = [];
